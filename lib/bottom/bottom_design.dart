...
class bottom_design extends StatefulWidget {
  @override
  bottom_designState createState() => bottom_designState();
}

class bottom_designState extends State<bottom_design> {
  int _index;
    ...
    return Scaffold(
      ...
      onTap: (int val) {
        ...
        if (val == 1) {
          ...
          Navigator.push(context, PageTransition(type: PageTransitionType.leftToRight, child: PreviewOrder()));
        }

...
import '../Controller/customer_services.dart';
                                  ...
                                  Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                          builder: (context) => CustomerOrderDetails(
                                                name: customer!.data[index].attributes.name.toString(),
                                                id: customer!.data[index].id,
                                                lastOrder: customer!.data[index].attributes.createdAt
                                                    .toString()
                                                    .substring(0, 10),
                                              )));
                                },
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            Text(
                                              customer!.data[index].attributes.name.toString(),
                                              style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14),
                                            ),
                                            //Text('Customer Name',style: TextStyle(fontWeight: FontWeight.w600,fontSize: 12,color: Color(0xff979797)),),
                                            Text(
                                              'Total Bill: ${customer!.data[index].id}',
                                              style: TextStyle(
                                                  fontWeight: FontWeight.w600, fontSize: 12, color: Color(0xff1170DE)),
                                            ),
                                          ],
                                        ),
                                        Column(
                                          ...
                                          children: [
                                            Column(
                                              children: [
                                                ...
                                                Text(
                                                  customer!.data[index].attributes.createdAt
                                                      .toString()
                                                      .substring(0, 10),
                                                  style: TextStyle(
                                            ...
                                            Text(
                                              'View',
                                              style: TextStyle(
                                                  fontWeight: FontWeight.w500, fontSize: 13, color: Color(0xff1170DE)),
                                            ),
                                          ],
                                        ),
                                      ],

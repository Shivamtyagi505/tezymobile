...
class input_sampleState extends State<input_sample> {
  ...
  Widget build(BuildContext context) {
    return Consumer<GenerateBillController>(builder: (context, controller, child) {
      return Scaffold(
              ...
              children: <Widget>[
                ...
                FloatingActionButton(
                  ...
                  onPressed: () {
                    ...
                    if (controller.categorieName == 'Blouse') {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => MeasurementScreen(selectVal: keyValue)),
                      );
                    } else if (controller.categorieName == 'Tops') {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => TopMeasurement(selectVal: keyValue)),
                      );
                    } else if (controller.categorieName == 'Bottom') {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => BottomMeasurement(selectVal: keyValue)),
                      );
                    } else if (controller.categorieName == 'Others') {
                      // Navigator.push(
                      //   context,
                      //   MaterialPageRoute(builder: (context) => MeasurementScreen(selectVal: keyValue)),
                      // );

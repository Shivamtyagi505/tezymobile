  ...
  Widget build(BuildContext context) {
    return Consumer<BlouseSelectDesignController>(
      builder: (context,value,child) {
        value.fetchSelectBackDesignApi();
        return Scaffold(
                ...
                Padding(
                        ...
                        child: MasonryGridView.count(
                          ...
                          itemBuilder: (context, index) {
                            return design(value.selectBackDesignClass![index].attributes!.productName!,value.selectBackDesignClass![index].attributes!.image!.data!.attributes!.name);
                          },
                        ),
                      ),
              ],

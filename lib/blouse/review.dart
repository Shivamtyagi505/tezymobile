              ...
              Padding(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Text("Customer Measurement",
                        style: TextStyle(
                            color: Color.fromRGBO(151, 151, 151, 10), fontSize: 15, fontWeight: FontWeight.w400)),
                    SizedBox(height: 7),
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          MeasurementWidget(
                            text1: 'Full Length',
                            text2: '${review.data.attributes.totalProducts[0].fullLength}',
                            text3: 'Shoulder',
                            text4: '${review.data.attributes.totalProducts[0].shoulder}',
                          ),
                          MeasurementWidget(
                            text1: 'Shoulder Gap',
                            text2: '${review.data.attributes.totalProducts[0].shoulderGap}',
                            text3: 'SleevesLength',
                            text4: '${review.data.attributes.totalProducts[0].sleevesLength}',
                          ),
                          MeasurementWidget(
                            text1: 'Armhole Round',
                            text2: '${review.data.attributes.totalProducts[0].armholeRound}',
                            text3: 'Circle Down Loose',
                            text4: '${review.data.attributes.totalProducts[0].circleDownLoose}',
                          ),
                          MeasurementWidget(
                            text1: 'Sleeve Round',
                            text2: '${review.data.attributes.totalProducts[0].sleevesRound}',
                            text3: 'Upper Chest Round',
                            text4: '${review.data.attributes.totalProducts[0].upperChestRound}',
                          ),
                          MeasurementWidget(
                            text1: 'Lower Chest Round',
                            text2: '${review.data.attributes.totalProducts[0].lowerChestRound}',
                            text3: 'Waist Round',
                            text4: '${review.data.attributes.totalProducts[0].waistRound}',
                          ),
                          MeasurementWidget(
                            text1: 'First Dart Point',
                            text2: '${review.data.attributes.totalProducts[0].firstDartPoint}',
                            text3: 'Second Dart Point',
                            text4: '${review.data.attributes.totalProducts[0].secondDartPoint}',
                          ),
                          MeasurementWidget(
                            text1: 'Bust Point',
                            text2: '${review.data.attributes.totalProducts[0].bustPoint}',
                            text3: 'Front AC',
                            text4: '${review.data.attributes.totalProducts[0].frontAc}',
                          ),
                          MeasurementWidget(
                            text1: 'Front Neck Deep',
                            text2: '${review.data.attributes.totalProducts[0].frontNeckDeep}',
                            text3: 'Back Neck Deep',
                            text4: '${review.data.attributes.totalProducts[0].backNeckDeep}',
                          ),
                          MeasurementWidget(
                            text1: 'Waist Band Length',
                            text2: '${review.data.attributes.totalProducts[0].waistBandLength}',
                            text3: 'Neck Width',
                            text4: '${review.data.attributes.totalProducts[0].neckWidth}',
                          ),
                        ],
                      ),
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        Column(children: [
                          Text('Cups'),
                          review.data.attributes.totalProducts[0].cups == false
                              ? Text('No', style: TextStyle(color: Color.fromRGBO(3, 43, 119, 10)))
                              : Text('Yes', style: TextStyle(color: Color.fromRGBO(3, 43, 119, 10)))
                        ]),
                        DottedLine(
                        ...
                        Column(children: [
                          Text('PIPING'),
                          review.data.attributes.totalProducts[0].piping == false
                              ? Text('NO', style: TextStyle(color: Color.fromRGBO(3, 43, 119, 10)))
                              : Text('Yes', style: TextStyle(color: Color.fromRGBO(3, 43, 119, 10)))
                        ]),
                        DottedLine(
                        ...
                        Column(children: [
                          Text('ZIP'),
                          Text('${review.data.attributes.totalProducts[0].zipType}',
                    ...
                    GestureDetector(
                        ...
                        child: Container(
                            ...
                            decoration:
                                BoxDecoration(color: Color(0xff1170DE), borderRadius: BorderRadius.circular(21)),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          InkWell(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => PreviewOrdersBlouse()));
                              },
                              child: Image.asset('assets/images/Group 1069.png')),
                ...
                children: [
                  ...
                  Row(children: [
                    Text("Date Of Delivery :",
                        style: TextStyle(
                            color: Color.fromRGBO(145, 144, 154, 10), fontSize: 12, fontWeight: FontWeight.w500)),
                    Text(review.data.attributes.totalBills[0].dueDate!.substring(3, 16),
                        style: TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.w500)),
                  ]),
                  SizedBox(height: 5),
                  Row(
                  ...
                  Expanded(
                    child: SizedBox(
                      ...
                      child: ListView.builder(
                          ...
                          shrinkWrap: true,
                          itemCount: review.data.attributes.totalProducts.length,

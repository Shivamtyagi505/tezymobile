...
class TotalProduct {
  ...
  factory TotalProduct.fromJson(Map<String, dynamic> json) => TotalProduct(
        ...
        hangingsImageTop:
            json["hangingsImage_top"] == null ? null : BackImageBlouse.fromJson(json["hangingsImage_top"]),
        ...
        fabricImageOther:
            json["fabricImage_other"] == null ? null : BackImageBlouse.fromJson(json["fabricImage_other"]),
      );

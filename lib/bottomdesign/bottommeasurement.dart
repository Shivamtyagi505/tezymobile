...
class _HomePageState extends State<HomePage> {
  ...
  int value = 0;
  List<String> delete = ['Crotch Length', 'Anckle Round', ];
                  ...
                  onTap: () {
                    setState(() {
                      ...
                      if(isSelected && FIRST_TIME==0){
                        mesuringList.add('Crotch Length',);
                        mesuringList.add('Anckle Round',);
                              ...
                              Container(
                                ...
                                child: HorizontalNumberPickerWrapper(
                                  ...
                                  onSelectedChanged: (value) {
                                    if(_listViewData[index]=='Hip')
                                      scaleData.setName('Hip');
                                    if(_listViewData[index]=='Full Length')
                                      scaleData.setName('Full Length');
                                    if(_listViewData[index]=='Waist Band')
                                      scaleData.setName('Waist Band');
                                    if(_listViewData[index]=='Thigh Round')
                                      scaleData.setName('Thigh Round');
                                    if(_listViewData[index]=='Knee Round')
                                      scaleData.setName('Knee Round');
                                    if(_listViewData[index]=='Knee Length')
                                      scaleData.setName('Knee Length');
                                    if(_listViewData[index]=='Crotch Length')
                                      scaleData.setName('Crotch Length');
                                    if(_listViewData[index]=='Anckle Round')
                                      scaleData.setName('Anckle Round');
                                  },
                                ),
                              ),
                              isSelected
              ...
              FloatingActionButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => selectotherdesign()),
                  );
                },

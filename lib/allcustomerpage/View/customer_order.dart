                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            CustomerOrderDetails(name: customer!.data[index].attributes.name
                                                .toString(), bill: customer!.data[index].id.toString(), lastOrder: customer!.data[index].attributes
                                                .createdAt
                                                .toString()
                                                .substring(0, 10),)));
                              },
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          Text(
                                            customer!.data[index].attributes.name
                                                .toString(),
                                            style: TextStyle(
                                                fontWeight: FontWeight.bold,
                                                fontSize: 14),
                                        ...
                                        children: [
                                          Column(
                                            children: [
                                              ...
                                              Text(
                                                customer!.data[index].attributes
                                                    .createdAt
                                                    .toString()
                                                    .substring(0, 10),
                                                style: TextStyle(

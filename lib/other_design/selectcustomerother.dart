...
import 'package:quikieappps1/other_design/design/select_other_design.dart';

class selectcustomerother extends StatefulWidget {
  @override
  selectcustomerotherState createState() => selectcustomerotherState();
}

class selectcustomerotherState extends State<selectcustomerother> {
...
prefixIcon:Icon(Icons.search) ,
              ...
              InkWell(
                onTap: () {
                     Navigator.push(context, MaterialPageRoute(builder: (context)=>selectotherdesign()));
                },
                child: Container(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          ...
                                          style:
                                              TextStyle(color: Color.fromRGBO(17, 112, 222, 1), fontSize: 12, fontWeight: FontWeight.w400),
                                        ),
                                      ),
                                    ],
                                  )
                  ...
                  decoration:
                      BoxDecoration(color: Colors.white, borderRadius: BorderRadius.vertical(top: Radius.circular(15))),
                ),
              ),
                ],
              ),

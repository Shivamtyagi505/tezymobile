...
import 'package:quikieappps1/other_design/bill/generatedbill.dart';
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                        onTap: () {
                                          Navigator.push(
                                              context, MaterialPageRoute(builder: (context) => PreviewOrderOther()));
                                        },
                                                          ...
                                                          InkWell(
                                                            onTap: () {
                                                              Navigator.push(
                                                                  context,
                                                                  MaterialPageRoute(
                                                                      builder: (context) => PreviewOrderOther()));
                                                            },
                                                            child: SvgPicture.asset(
                                                              "assets/images/Edit Order.svg",
                                                            ),

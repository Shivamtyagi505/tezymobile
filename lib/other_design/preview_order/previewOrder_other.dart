...
import 'package:quikieappps1/other_design/place_order/placeOrder.dart';
import 'package:toggle_switch/toggle_switch.dart';

class PreviewOrderOther extends StatefulWidget {
  @override
  _PreviewOrderOtherState createState() => _PreviewOrderOtherState();
}
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text("Saree", style: TextStyle(color: secondaryColor, fontSize: 15, fontWeight: FontWeight.w500)),
                    ],
                  ),
                ],
              ),

...
class OtherReviewSecond extends StatefulWidget {
  @override
  OtherReviewSecondState createState() => OtherReviewSecondState();
}

class OtherReviewSecondState extends State<OtherReviewSecond> {
  int _index;
  ...
  Widget selectedImage(bool top) {
    return Row(
      children: [
        imageContainer(top, true, 'Customer Fabric'),
        SizedBox(width: 5),
        imageContainer(top, false, 'Style Reference')
      ],
    );
  }
        ...
        Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(
                ...
                children: [
                  Column(
                      children: [Text('DrawString\n(Nada)',textAlign: TextAlign.center,), Text('Yes', style: TextStyle(color: Color.fromRGBO(3, 43, 119, 10)))]),
                  DottedLine(
                  ...
                  Column(
                      children: [Text('Elastic'), Text('NO', style: TextStyle(color: Color.fromRGBO(3, 43, 119, 10)))]),
                  DottedLine(
                    direction: Axis.vertical,
                    lineLength: 52,
                    lineThickness: 1.0,

...
class OtherReview extends StatefulWidget {
  @override
  OtherReviewState createState() => OtherReviewState();
}
        ...
        Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(
                ...
                children: [
                  Column(
                      children: [Text('Zig Zag'), Text('NO', style: TextStyle(color: Color.fromRGBO(3, 43, 119, 10)))]),
                  DottedLine(
                  ...
                  Column(
                      children: [Text('Falls'), Text('Yes', style: TextStyle(color: Color.fromRGBO(3, 43, 119, 10)))]),
                ],
              ),
              SizedBox(
                height: 19,

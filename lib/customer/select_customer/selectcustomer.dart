...
class selectCustomerState extends State<selectCustomer> {
  ...
  Widget build(BuildContext context) {
    return Consumer<SelectCustomerController>(builder: (context, value, child) {
      return value.allCustomerModelItems == null
                  ...
                  child: Column(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        shrinkWrap: true,
                        itemCount: value.customer?.data.length ?? 0,
                        itemBuilder: (BuildContext context, int index) {
                          int itemCount = value.customer?.data.length ?? 0; //customer?.data.length
                          int reversedIndex = itemCount - 1 - index;
                          //final user = searchItem[191];
                          late String position =
                              value.allCustomerModelItems!.data![reversedIndex].attributes!.name.toString();
                          if (searchController.text.isEmpty) {
                            return InkWell(
                              onTap: () {
                                Navigator.of(context).push(MaterialPageRoute(builder: (context) => input_sample()));
                                value.getCustomerData(value.allCustomerModelItems!.data![reversedIndex].attributes!,
                                    value.allCustomerModelItems!.data![reversedIndex].id!);
                              },
                              child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                child: Text(
                                                  // user.toString(),
                                                  value.allCustomerModelItems!.data![reversedIndex].attributes!.name
                                                      .toString(),
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Text(
                                                "Bills ${value.filteredAllCustomerModel?[reversedIndex].invoiceNumber ?? '33'}",
                                              ...
                                              Container(
                                                ...
                                                height: 20,
                                                decoration: BoxDecoration(
                                                    color: Color(0xff032B77), borderRadius: BorderRadius.circular(10)),
                                                child: Text(
                                                  "Select",
                                                  style: TextStyle(

...
import 'package:quikieappps1/topdesign/design/after_selection.dart';
import 'package:quikieappps1/topdesign/design/select_back_design.dart';
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (int val) {
          ...
          if (val == 1) {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => PreviewOrderTop()),
            );

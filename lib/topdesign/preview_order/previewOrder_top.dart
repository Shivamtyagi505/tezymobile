...
import 'package:quikieappps1/topdesign/drawing_pad/Drawing_Pad.dart';
import 'package:quikieappps1/topdesign/place_order/placeOrder.dart';
import 'package:toggle_switch/toggle_switch.dart';

class PreviewOrderTop extends StatefulWidget {
  @override
  _PreviewOrderTopState createState() => _PreviewOrderTopState();
}

class _PreviewOrderTopState extends State<PreviewOrderTop> {
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            Row(
                              children: [
                                picWithHead('HANGINGS', 'Select or upload hanging or else leave blank'),
                                picWithHead('DRAWING PAD', 'You can draw pattern or type any text here')
                              ],
                            ),
                            Divider(),
                          ],
